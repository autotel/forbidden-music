...
import { ArraySynthParam, BooleanSynthParam, OptionSynthParam, ParamType, SynthParam } from "../types/SynthParam";
import { EventParamsBase, PatcheableSynthVoice, Synth } from "../types/Synth";
...
export class FourierVoice implements PatcheableSynthVoice {
    ...
    enable = () => { }
    disable = () => { }
    constructor(audioContext: AudioContext, periodicWaveRef: SimpleRef<PeriodicWave>, proportionalAttackRef: ProportionalAttackRef) {
        ...
        this.scheduleStart = (
            ...
            // Use fast attack (0.01s) if proportional attack is disabled
            if (perc || !proportionalAttackRef.value) {
        ...
        this.scheduleEnd = (
            ...
            if (absoluteStopTime) {
                ...
                if (proportionalAttackRef.value) {
                    gainNode.gain.linearRampToValueAtTime(noteVelocity, noteStartedTime + duration / 4);
                }
...
export class FourierSynth extends Synth {
    ...
    proportionalAttackRef: ProportionalAttackRef = { value: false };
    ...
    constructor(
        ...
        super(
            audioContext,
            () => (new FourierVoice(audioContext, this.periodicWaveRef as SimpleRef<PeriodicWave>, this.proportionalAttackRef))
        );
        ...
        this.params.push(this.levelsArrayParam)
        this.phasesArrayParam = {
            displayName: "phases",
            type: ParamType.nArray,
            min: -1,
            max: 1,
        ...
        this.params.push(this.phasesArrayParam)
