// by https://github.com/g200kg/audioworklet-adsrnode

export default class AdsrNode extends AudioWorkletNode {
    attack: AudioParam;
    ...
    constructor(actx:AudioContext, options: { [key: string]: any }){
