...
import { Note, getFrequency, note } from "../dataTypes/Note";
...
export const usePlaybackStore = defineStore("playback", () => {
    ...
    const synthParamToAccessorString = (param?: SynthParam) => {
        ...
        const synthWithParam = channels.value.find((channel) => channel.params.includes(param));
        if (!synthWithParam) throw new Error("synth with param not found");
        const synthName = synthWithParam.synth.name;
