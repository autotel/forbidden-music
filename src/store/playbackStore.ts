...
import { Note, getDuration, getFrequency, note } from "../dataTypes/Note";
import { duration, transposeTime } from "../dataTypes/Trace";
...
export const usePlaybackStore = defineStore("playback", () => {
    ...
    const _clockAction = () => {
        ...
        if (loopRestarted) {
            ...
            const transposeNoteTime = duration(loopRestarted);
